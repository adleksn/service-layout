...
describe('service page supplied copy layout', () => {
  it('uses the supplied line breaks in shopper reports and service description', () => {
    ...
    expect(app).toContain('Обратилась в первые, было немного страшно доверять данные карты незнакомому сервису. Но всё<br> прошло хорошо, деньги списались ровно в заявленом размере, чек пришел на почту.');
